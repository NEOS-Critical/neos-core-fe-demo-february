...
const Exchange = () => {
  ...
  return (
    <div class="w-[1440px] h-[1215px] relative bg-[#f6f5f2]">
      <div class="w-[1380px] h-[497px] absolute left-[59px] top-[717px] opacity-50 bg-[#f6f5f2]"></div>
      <div class="flex justify-start items-start w-[1372px] h-[1042px] absolute left-[68px] top-[156px] gap-2 px-10 py-4">
        <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 h-[1026px] w-[1299px] relative gap-4">
          ...
          <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-8">
            <div class="flex justify-between items-start flex-grow relative">
              <p class="flex-grow-0 flex-shrink-0 text-base text-left text-black">
                Data Products shared with me
              </p>
          ...
          <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-5">
            <div
              class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[314px] overflow-hidden bg-white border border-gray-200"
              style={{ boxShadow: '0px 1px 3px 0 rgba(0,0,0,0.1), 0px 1px 2px 0 rgba(0,0,0,0.06)' }}
            >
              <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden gap-2.5 p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2.5">
                  <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                    <p class="flex-grow-0 flex-shrink-0 w-[330px] text-sm text-left text-[#1e1b19]">
            ...
            >
              ...
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 12th Jan 2023 13:23
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M1304.44 1.00418H0V0H1304.44V1.00418Z"
              fill="#CCC6BB"
            ></path>
          </svg>
          <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-8 pt-2">
            <div class="flex justify-start items-start flex-grow relative">
              <p class="flex-grow-0 flex-shrink-0 text-base text-left text-black">
                All Data Products
              </p>
            </div>
          ...
          <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-5">
            <div
              class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 h-[228px] w-[309.75px] overflow-hidden bg-white border border-gray-200 cursor-pointer"
              style={{ boxShadow: '0px 1px 3px 0 rgba(0,0,0,0.1), 0px 1px 2px 0 rgba(0,0,0,0.06)' }}
              onClick={() => navigate('/worker-profile-details')}
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2.5">
                  <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                    <p class="flex-grow-0 flex-shrink-0 w-[330px] text-sm text-left text-[#1e1b19]">
                      Worker profile
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    <span class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                      This data product provides all the worker details
                      including their IDs, personal information, country ..
                    </span>
                    <br />
                  </p>
                </div>
              ...
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 3 hours ago
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
              ...
              <div class="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 overflow-hidden p-2.5 border-t border-r-0 border-b-0 border-l-0 border-[#e6e2da]">
                ...
                <div class="flex justify-end items-center flex-grow gap-2.5">
                  <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden px-3 py-2 rounded-[3px] bg-white border border-[#1e1b19]">
                    <p class="flex-grow-0 flex-shrink-0 text-[10px] text-left text-[#1e1b19]">
                      Get Access
                    </p>
                  </div>
                </div>
            ...
            <div
              class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 h-[228px] w-[309.75px] overflow-hidden bg-white border border-gray-200"
              style={{ boxShadow: '0px 1px 3px 0 rgba(0,0,0,0.1), 0px 1px 2px 0 rgba(0,0,0,0.06)' }}
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2.5">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    This data product provides learner details, certification
                    numbers, acceptance and expiry date..
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 6 hours ago
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
              ...
              <div class="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 overflow-hidden p-2.5 border-t border-r-0 border-b-0 border-l-0 border-[#e6e2da]">
                ...
                <div class="flex justify-end items-center flex-grow gap-2.5">
                  <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden px-3 py-2 rounded-[3px] border border-[#34302c]">
                    <p class="flex-grow-0 flex-shrink-0 text-[10px] text-left text-[#1e1b19]">
                      Get Access
                    </p>
                  </div>
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    This data product provides worker assessments and results.
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received Yesterday 21:34
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2.5">
                  <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                    <p class="flex-grow-0 flex-shrink-0 w-[330px] text-sm text-left text-[#1e1b19]">
                      Construction site check-in outs
                    </p>
                  </div>
                  <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 gap-2.5">
                    <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 h-6 relative gap-1 px-2 rounded-[3px] bg-[#cce5ff]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    This data product provide check-ins and check-outs for each
                    worker.
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received Yesterday 0:10
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
          ...
          <div class="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-5">
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    Data product containing preferences around hotel rooms
                    (budget, location), party size, hotels...
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 5th Feb 2023 15:45
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    Data product containing visitor preferences in terms of
                    transportation (e.g. taxi, shuttle, buses...
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 22th Jan 2023 10:00
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    Data product containing visitor preferences when booking
                    services/activites, coming from the Touris..
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 25th Jan 2023 11:00
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
            ...
            >
              <div class="flex flex-col justify-between items-start self-stretch flex-grow overflow-hidden p-2.5 border-t-0 border-r-0 border-b border-l-0 border-[#e6e2da]">
                ...
                <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5">
                  <p class="flex-grow-0 flex-shrink-0 w-[290px] h-10 text-xs font-light text-left text-[#1e1b19]">
                    Composite data product from privacy, hotels, transportation
                    ans service preferences data ..
                  </p>
                </div>
              </div>
              <div class="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 overflow-hidden px-2.5 py-1">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
                    Latest data received 22th Jan 2023 15:45
                  </p>
                </div>
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[5px]">
                  <p class="flex-grow-0 flex-shrink-0 text-xs font-light text-left text-[#1e1b19]">
      ...
      <div class="flex justify-between items-end w-[1292px] absolute left-[108px] top-20">
        ...
        >
          ...
          <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2 px-4 py-2.5 bg-[#f0f5ff] border-t-0 border-r border-b-0 border-l-0 border-gray-300 cursor-pointer" onClick={() => navigate('/exchange-only-mine')}>
            <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-[#1d2939]">
              Only Mine
            </p>
          </div>
          <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2 px-4 py-2.5 bg-white border-t-0 border-r border-b-0 border-l-0 border-[#d0d5dd] cursor-pointer" onClick={() => navigate('/exchange-all')}>
      ...
      <div class="w-[68px] h-[1215px] absolute left-0 top-0">
        <div class="w-[67px] h-[1215px] absolute left-0 top-0 bg-white">
      ...
      <div
        class="flex justify-start items-center w-[510px] absolute left-[528px] top-[39px] pl-4 pr-2 py-2 rounded bg-[#0e7a53]"
      ...
      >
        <div class="flex justify-start items-center flex-grow relative gap-2">
          <p class="flex-grow w-[426px] text-sm text-left text-white">
            Individual Learner Records published successfully!
          </p>
