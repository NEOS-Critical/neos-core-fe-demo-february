  ...
  return (
    <div class="w-[1440px] h-[980px] relative bg-[#f6f5f2]">
      <div class="flex justify-between items-end w-[1292px] absolute left-[108px] top-20">
        ...
        >
          <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2 px-4 py-2.5 bg-white border-t-0 border-r border-b-0 border-l-0 border-[#1f2a37] cursor-pointer" onClick={() => navigate('/exchange-available')}>
      ...
      <div class="flex justify-start items-start w-[1372px] h-[689px] absolute left-[68px] top-[156px] gap-2 px-10 py-4">
        <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 h-[690px] w-[1299px] gap-4">
        ...
        <div class="w-[67px] h-[980px] absolute left-0 top-0 bg-white">
          <div class="flex flex-col justify-start items-center w-[67px] absolute left-0 top-[62px] gap-3">
            ...
            >
              ...
              ></rect>
              <path
                d="M40.7694 26.5471C39.3601 27.9565 37.556 28.9079 35.5855 29.2811C33.6149 29.6543 31.5664 29.4325 29.6989 28.6437C27.8314 27.8549 26.2288 26.5345 25.0938 24.8496C23.9588 23.1647 23.3424 21.1909 23.3225 19.1778C23.3025 17.1647 23.88 15.2027 24.9819 13.5399C26.0837 11.8771 27.6604 10.5883 29.5127 9.83631C31.3649 9.08435 33.4095 8.90304 35.3878 9.31533C37.3661 9.72761 39.1893 10.715 40.6269 12.1526L33.512 19.2675L40.7694 26.5471Z"
                fill="#1E1B19"
              ></path>
              <path
              ...
              <path
                ...
                fill="url(#paint0_radial_583_471886)"
              ></path>
              <path
