    ...
    <div class="w-[1440px] h-[980px] relative bg-[#f6f5f2]">
      ...
      <div class="flex justify-between items-end w-[1292px] absolute left-[108px] top-20">
        ...
        >
          ...
          <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2 px-4 py-2.5 bg-white border-t-0 border-r border-b-0 border-l-0 border-gray-300 cursor-pointer" onClick={() => navigate('/exchange-shared')}>
        ...
        <div class="w-[67px] h-[980px] absolute left-0 top-0 bg-white">
          <div class="flex flex-col justify-start items-center w-[67px] absolute left-0 top-[62px] gap-3">
            ...
            >
              ...
              ></rect>
              <path
                d="M40.7694 26.5469C39.3601 27.9563 37.556 28.9077 35.5855 29.2809C33.6149 29.6541 31.5664 29.4323 29.6989 28.6435C27.8314 27.8547 26.2288 26.5343 25.0938 24.8494C23.9588 23.1645 23.3424 21.1907 23.3225 19.1776C23.3025 17.1645 23.88 15.2025 24.9819 13.5397C26.0837 11.877 27.6604 10.5881 29.5127 9.83613C31.3649 9.08416 33.4095 8.90286 35.3878 9.31514C37.3661 9.72743 39.1893 10.7148 40.6269 12.1524L33.512 19.2673L40.7694 26.5469Z"
                fill="#1E1B19"
              ></path>
              <path
              ...
              <path
                ...
                fill="url(#paint0_radial_583_471857)"
              ></path>
              <path
                d="M45.7295 16.0135L45.1095 16.798C45.7872 17.3337 46.2255 18.1146 46.3291 18.9676C46.4327 19.8203 46.1935 20.6745 45.6666 21.3435C45.1397 22.0124 44.3667 22.4435 43.5162 22.5409C42.6833 22.6362 41.8423 22.4036 41.1715 21.8913L41.141 21.8608L41.0983 21.8266C40.5375 21.3766 39.8228 21.1623 39.1066 21.232C38.3902 21.3018 37.7301 21.6505 37.2696 22.2043L37.2641 22.211L37.2587 22.2177C36.649 22.9775 35.8169 23.528 34.8768 23.7929C33.9364 24.0578 32.9336 24.0241 32.0067 23.6949C31.0797 23.3656 30.2752 22.7573 29.7047 21.9536C29.1342 21.15 28.8266 20.1918 28.8231 19.2117C28.8196 18.2318 29.1203 17.2784 29.6824 16.4826C30.2445 15.6867 31.0411 15.0865 31.9629 14.7649C32.8847 14.4432 33.887 14.4159 34.8316 14.6882C35.7762 14.9605 36.6159 15.519 37.234 16.2869L37.2399 16.2942L37.246 16.3015C37.7067 16.8522 38.3641 17.2031 39.0786 17.2777C39.7935 17.3524 40.5093 17.1445 41.0718 16.6963L41.1159 16.6612L41.1376 16.6394C41.7054 16.2318 42.3932 16.0198 43.098 16.0379C43.8253 16.0566 44.5284 16.3193 45.0935 16.7851L45.7295 16.0135Z"
                stroke="#1E1B19"
                stroke-width="2"
              ></path>
...
export default ExchangeSharedWithMe;
